...
class ParallelToM2(Subcommand):
    def add_subparser(self, name: str, parser: argparse._SubParsersAction) -> argparse.ArgumentParser:
        ...
        subparser.add_argument("-orig", help="The path to the original text file.", required=True)
        subparser.add_argument("-cor", help="The paths to >= 1 corrected text files.", nargs="+", default=[], required=True)
        ...
        subparser.add_argument("-merge", choices=["rules", "all-split", "all-merge", "all-equal"], default="rules",
