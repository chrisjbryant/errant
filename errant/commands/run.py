...
def main() -> None:
    prog = 'errant'
    parser = argparse.ArgumentParser(description="Run ErrAnnT", usage='%(prog)s', prog=prog)
    ...
    for name, subcommand in subcommands.items():
        subparser = subcommand.add_subparser(name, subparsers) # pylint: disable=unused-variable
